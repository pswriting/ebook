...
:root {
    ...
    --surface-2: rgba(30, 34, 43, 0.96);
    --surface-3: rgba(246, 242, 232, 0.06);
    --text: #f5f1e8;
    --text-bright: #fffaf0;
    --text-dim: #a6a096;
    --text-muted: #746f67;
    --line: rgba(224, 211, 184, 0.16);
    --line-strong: rgba(224, 211, 184, 0.28);
    --gold: #d7b86a;
    --gold-light: #f0d58b;
    --gold-dark: #a98134;
    --accent: #7bd3c8;
...
.stApp {
    ...
    background:
        ...
        linear-gradient(180deg, #111318 0%, #0c0e12 46%, #111318 100%) !important;
...
.main .block-container {
    ...
    padding: 2.4rem 2rem 4rem !important;
}
...
.workspace-hero {
    ...
    margin: 10px 0 18px;
    background:
        linear-gradient(135deg, rgba(247, 244, 236, 0.10), rgba(247, 244, 236, 0.035)),
...
.nav-item.active {
    background: rgba(247, 244, 236, 0.13) !important;
    color: var(--text-bright) !important;
